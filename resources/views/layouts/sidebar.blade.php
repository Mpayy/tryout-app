<!-- Sidebar Wrapper -->
<div class="w-64 bg-white border-r border-gray-200 min-h-screen hidden sm:block">
    <div class="p-4">
        <!-- Komponen Menu dari DaisyUI -->
        <ul class="menu menu-md w-full rounded-box gap-1 text-gray-600 font-medium">
            
            <!-- Menu Global / Dashboard (Bisa diakses semua role yang login) -->
            <li>
                @role('admin')
                    <a href="{{ route('admin.dashboard') }}" class="{{ request()->routeIs('admin.dashboard') ? 'active bg-teal-50 text-teal-700 font-semibold' : '' }}">
                ...
                @endrole
                @role('guru')
                    <a href="{{ route('guru.dashboard') }}" class="{{ request()->routeIs('guru.dashboard') ? 'active bg-teal-50 text-teal-700 font-semibold' : '' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        Dashboard
                    </a>
                @endrole
                @role('siswa')
                    <a href="{{ route('siswa.dashboard') }}" class="{{ request()->routeIs('siswa.dashboard') ? 'active bg-teal-50 text-teal-700 font-semibold' : '' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        Dashboard
                    </a>
                @endrole
            ...
            @role('admin')
                ...
                <li>
                    <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.index') ? 'active bg-teal-50 text-teal-700 font-semibold' : '' }}">
                ...
                <li>
                    <a href="{{ route('admin.mapels.index') }}" class="{{ request()->routeIs('admin.mapels.index') ? 'active bg-teal-50 text-teal-700 font-semibold' : '' }}">
