        ...
        <div class="card bg-primary text-primary-content shadow-sm overflow-hidden">
            <div class="card-body p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div class="text-right hidden sm:block">
                    <div class="text-sm text-primary-content/60">{{ \Carbon\Carbon::now()->translatedFormat('l') }}
                    </div>
            ...
            @if($ujianTersedia->isEmpty())
                <div class="card bg-base-100 border border-base-200 shadow-sm">
                    <div class="card-body items-center text-center py-10">
                        <div
                            class="w-12 h-12 bg-base-200 border border-base-300 rounded-full flex items-center justify-center mb-3 text-base-content/30">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <p class="text-xs text-base-content/40 mt-0.5">Cek kembali nanti atau lihat jadwal ujian akan
                            datang.</p>
                    </div>
                </div>
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    @foreach($ujianTersedia as $paket)
                        ...
                        @endphp
                        <div
                            class="card bg-base-100 border {{ $sedang ? 'border-warning/40' : 'border-base-200' }} shadow-sm hover:shadow-md transition-all duration-200">
                            <div class="card-body p-5 gap-3">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="bg-base-200/60 border border-base-200 rounded-lg p-2 text-center">
                                        <div class="text-[10px] font-bold uppercase tracking-wider text-base-content/40">Durasi
                                        </div>
                                        <div class="text-xs font-bold text-base-content mt-0.5">{{ $paket->durasi }} Menit</div>
                                    </div>
                                    <div class="bg-base-200/60 border border-base-200 rounded-lg p-2 text-center">
                                        <div class="text-[10px] font-bold uppercase tracking-wider text-base-content/40">Soal
                                        </div>
                                        <div class="text-xs font-bold text-base-content mt-0.5">{{ $paket->jumlah_soal }} Butir
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-body p-0">
                                        ...
                                        <tr class="hover:bg-base-200/20 align-middle">
                                            ...
                                            <td class="text-center">
                                                <div class="flex flex-col items-center gap-0.5">
                                                    <span
                                                        class="text-base font-bold {{ $sesi->lulus ? 'text-success' : 'text-error' }}">
                                                        {{ $sesi->nilai }}
                                                    </span>
                                                    <progress
                                                        class="progress w-10 h-1 {{ $sesi->lulus ? 'progress-success' : 'progress-error' }}"
                                            ...
                                            <td class="text-center">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <span class="text-[10px] text-base-content/40">dari
                                                        {{ $sesi->total_peserta }}</span>
                                                </div>
                                            </td>
                    ...
                    @if($riwayatUjian->isNotEmpty())
                        <div class="px-5 pb-5 pt-4 border-t border-base-200">
                            <p class="text-xs font-bold text-base-content/50 uppercase tracking-wider mb-3">Tren Nilai (10
                                ujian terakhir)</p>
                                ...
                                <div class="px-5 py-3.5 hover:bg-base-200/20 transition-colors">
                                    <div class="flex items-start justify-between gap-2">
                                        ...
                                        <div class="shrink-0 text-right">
                                            ...
                                            @else
                                                <span class="badge badge-ghost badge-xs font-medium">{{ floor($sisaHari) }}
                                                    hari</span>
                                            @endif
                                        </div>
                                    </div>
