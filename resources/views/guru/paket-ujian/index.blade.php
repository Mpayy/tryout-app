            ...
            <tr class="hover align-middle">
                ...
                <td class="text-xs text-base-content/70">
                    <div class="flex flex-col gap-0.5">
                        <span>Mulai: <b class="text-base-content">{{ \Carbon\Carbon::parse($paket->tanggal_mulai)->format('d M Y') }}</b></span>
                        <span>Selesai: <b class="text-base-content">{{ \Carbon\Carbon::parse($paket->tanggal_selesai)->format('d M Y') }}</b></span>
                    </div>
                </td>
            ...
            <tr>
                <td colspan="7">
                    <div class="flex flex-col items-center gap-3 py-16 text-center">
                        <div class="w-16 h-16 rounded-full bg-base-200 border border-base-300 flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-base-content/40 mt-0.5">Klik "Tambah Paket Ujian" untuk membuat paket baru.</p>
                        </div>
                    </div>
                </td>
            </tr>
    ...
    <x-form-modal>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="form-control col-span-1 sm:col-span-2">
                ...
                <div class="grid grid-cols-2 gap-2 p-3 bg-base-200/40 border border-base-200 rounded-xl max-h-40 overflow-y-auto">
                    @foreach($daftarKelas as $kelas)
                        <label class="flex items-center gap-2.5 p-2 border border-transparent hover:border-base-300 hover:bg-base-100 rounded-lg cursor-pointer transition duration-150">
