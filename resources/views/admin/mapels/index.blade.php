    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500">Kelola daftar mata pelajaran.</p>
            </div>
            <div>
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            @foreach ($mapels as $mapel)
                                <tr class="hover:bg-slate-50/50 transition duration-150">
                                    ...
                                    <td class="font-semibold text-slate-800">{{ $mapel->nama }}</td>
                                    <td class="text-center font-medium">{{ $mapel->kode }}</td>
                                    <td class="text-center">{{ $mapel->deskripsi }}</td>
        ...
        <div class="modal-box bg-white border border-slate-200/80 shadow-xl max-w-2xl p-6 rounded-xl text-slate-700">
            ...
            <form id="form" method="POST" action="" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-control w-full">
                        <label class="label py-1"><span class="label-text font-semibold text-slate-700 text-sm">Deskripsi
                                Mata Pelajaran</span></label>
